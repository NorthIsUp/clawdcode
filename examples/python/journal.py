#!/usr/bin/env python3
"""
Append-only operation journal for Errandd agents.
...
JOURNAL_FILE = os.path.expanduser("~/.errandd/journal/operations.jsonl")
SESSION_FILE = os.path.expanduser("~/.errandd/journal/current-session.json")
